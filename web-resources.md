...
- [Vivino](https://www.vivino.com/) - consumer ratings, review counts, bottle images, and sometimes prices. Search by wine name. Cite retrieval date.
...
- [Wine-Searcher Recanati Marawi](https://www.wine-searcher.com/find/recanati+marawi+upper+galilee+israel) - example bottle-specific availability and price page.
...
Note: the aptash/vivino-api Node.js scraper is confirmed broken as of 2026-06-09 due to Vivino URL and DOM changes. Use web search to reach Vivino pages directly instead.

## Export And Diaspora Buying

For users outside Israel wanting to purchase Israeli wine:

- [Royal Wine Corp / Kedem](https://www.royalwine.com/) - dominant US importer of kosher Israeli wine; carries Yarden, Gamla, Carmel, Dalton, Recanati, Barkan, and others. Best starting point for US kosher Israeli wine.
- [Wine-Searcher](https://www.wine-searcher.com/) - most reliable cross-country bottle finder; search by wine name and country to find global retailers. Useful for both kosher and non-kosher Israeli wine.
- [Wine-Searcher advanced search](https://www.wine-searcher.com/find/) - use wine name plus "Israel" to locate internationally available bottles.
- For non-kosher boutique wines (Castel, Tzora, Clos de Gat, Sphera, Flam): distribution outside Israel is more limited. Wine-Searcher and specialist importers are the best route to find availability.
- Liberty Wines (UK) handles some boutique Israeli producers; check their site or search `[winery name] UK importer`.
- For Germany and EU: search `[wine name] kaufen` or look for specialist wine importers in those markets.

Key guidance: Israeli kosher wine (Yarden, Carmel, Dalton, Recanati, Barkan) is widely exported and easy to find in the US, UK, and many European cities. Non-kosher boutique wine is harder to find outside Israel; Wine-Searcher is the most reliable way to locate it.
